...
public class ClavisCategoryAdapter extends RecyclerView.Adapter<ClavisCategoryAdapter.Holder> {

    private Context context;
    private List<ProductData> productsList;
    private OnItemClickListener clickListener;

    ClavisCategoryAdapter(Context context, List<ProductData> productsList) {
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ClavisCategoryAdapter.Holder(view, clickListener);
    }

...
public class PropertyAdapter extends RecyclerView.Adapter<PropertyAdapter.Holder> {
    ...
    private List<PropertyData> productsList;
    private OnItemClickListener clickListener;

    public PropertyAdapter(Context context, List<PropertyData> productsList) {
    ...
    public void onBindViewHolder(@NonNull Holder holder, final int position) {
        final PropertyData productData = productsList.get(position);
